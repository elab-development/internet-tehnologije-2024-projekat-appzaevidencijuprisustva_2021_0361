...
function TeachingPlanTable({
  expandedTeachingPlanId,
  lessons,
  lessonsLoading,
  onCreateLesson,
  onDelete,
          ...
          <tbody className="divide-y divide-slate-200">
            {teachingPlans.map((teachingPlan) => (
              <Fragment key={teachingPlan.id}>
                  ...
                  <td className="px-4 py-4 align-top">
                    <div className="flex flex-wrap justify-end gap-2">
                      <button
                        ...
                        type="button"
                        onClick={() => onToggleLessons(teachingPlan)}
                      >
                        {expandedTeachingPlanId === teachingPlan.id ? 'Hide lessons' : 'Lessons'}
                      </button>
                      <button
                ...
                {expandedTeachingPlanId === teachingPlan.id && (
                  <tr>
